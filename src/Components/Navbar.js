    ...
    <header className="z-10 w-full px-32 lg:px-16 md:px-12 sm:px-6 font-medium py-8 flex items-center justify-between dark:text-light relative">
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav>
          ...
          ></CustomLink>
          <CustomLink
            href="https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&to=shujahyder313@gmail.com"
            title={"Contact"}
            className={"ml-6"}
          ></CustomLink>
        </nav>
        <nav className="flex item-center justify-center flex-wrap">
          <motion.a
            href={"https://github.com/shujah19"}
            target="_blank"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-8 mr-3"
          ...
          <motion.a
            href={"https://www.linkedin.com/in/shujahaider313/"}
            target="_blank"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-8 ml-3"
        ...
        >
          <nav className="flex items-center flex-col justify-center">
            ...
            <CustomMobileLink
              toggle={handlleClick}
              href={
                "https://mail.google.com/mail/u/0/?fs=1&tf=cm&source=mailto&to=shujahyder313@gmail.com"
              }
              title={"Contact"}
              className={""}
            ></CustomMobileLink>
          ...
          <nav className="flex item-center justify-center flex-wrap mt-2">
            ...
            <motion.a
              href={"https://www.linkedin.com/in/shujahyder313"}
              target="_blank"
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="w-8 ml-3"
